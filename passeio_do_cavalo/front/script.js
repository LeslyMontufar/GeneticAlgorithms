...
async function runGeneticAndAnimate() {
	try {
		...
		knightMoves = await geneticAlgorithm({ iterations: epochs, population: population, pm: pm, pc: pc, tournamentSize: 3, pElitism: pElitism }, fnc_update_progress = atualizarBarraProgresso);
