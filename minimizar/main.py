    ...
    for generation in range(generations):
        ...
        for _ in range(len(population)//2):
            ...
            if random.random() < mutation_rate:
                ...
                mutation_value = random.uniform(-5.12, 5.12)
...
def calculate(mutation_rate, crossover_rate, generations, population_size, element_count):
    ...
    initial_population = [Individual([random.uniform(-5.12, 5.12) for _ in range(element_count)]) for _ in range(population_size)]
