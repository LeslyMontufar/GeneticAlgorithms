...
async function geneticAlgorithm(iterations = 100, populationSize = 50) { // pontos é var global
    ...
    for (let i = 0; i < iterations; i++) {        
        ...
        desenharTudo(i+1);
        await new Promise(resolve => setTimeout(resolve, 50)); // pequena pausa pra animar
    }
